...
public class AuthClientApplication extends WebSecurityConfigurerAdapter {
    ...
    public @ResponseBody
    ResponseEntity<HashMap> hello(HttpServletRequest request) throws URISyntaxException {
        return template.getForEntity(new URI("http://10.104.236.53:8000/api/station/greeting"), HashMap.class);
    }
    ...
    public Map<String, Object> user(OAuth2Authentication oAuth2Authentication) {
        ...
        if (oAuth2Authentication != null) {
            map.put("data", oAuth2Authentication.getUserAuthentication().getDetails());
        }
        return map;
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .anyRequest().authenticated().and().logout().logoutSuccessHandler(new LoginOutSuccessHandler())
                .and().csrf()
